...
window.addEventListener('DOMContentLoaded', function() {
  ...
  */
  ...
  function start() {
    ...
    var backgroundColor = hslColor(backgroundHue, backgroundSaturation, backgroundLuminance);
  ...
  function addShapeToDOM() {
    ...
    shape.style.color = hslColor(topBorderHue, topBorderSaturation, topBorderLuminance);
  ...
  function addInteractionToShapeContainers() {
    ...
    var shapeContainers = document.querySelectorAll('.' + shapeContainerClassName);
